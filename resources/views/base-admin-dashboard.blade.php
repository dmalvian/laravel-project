...
<html>
  ...
  <body>
    <nav class="navbar has-shadow">
        <div class="container">
            <div class="navbar-brand"><a class="navbar-item" href="{{ url('admin/dashboard') }}"><h2 class="title cust-font">RSing</h2></a>
                ...
                <div class="navbar-end">
                    <div class="navbar-item has-dropdown is-hoverable"><a class="navbar-link">Account</a>
                        <div class="navbar-dropdown">
                            <a href="{{ url('admin/logout') }}" class="navbar-item">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
